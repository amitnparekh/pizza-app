...
const updatePizzaOrder = async (pizzaType, pizzaQty, userId) => {
  ...
  try {
    ...
    if(auth0Manage != null) {
      ...
      //const testUserID = "google-oauth2|116435906027154071356";

      // The below line is not giving the userProfile. Which user attribute to use as 'userId'?
...
app.post("/api/takePizzaOrder", (req, res) => {
  ...
  */
  ...
  const orderConfirmationMessage = "Your pizza order received successfully! Pizza Type: " + pizzaType + ", Quantity: " + pizzaQty;
  //res.send({
